	...
	<script>
		...
		$("#create-accountName").typeahead({
			source: function (customerName, process) {
				...
				$.post("${pageContext.request.contextPath}/workbench/transaction/queryCustomerName",
		...
		$('#create-transactionStage').change(function () {
			$.get("${pageContext.request.contextPath}/workbench/transaction/stagePossibility",{'stage':$(this).val()},function (data) {
				//data:可能性
